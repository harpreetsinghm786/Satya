...
public class orderconfirmationstep2_buynow extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_orderconfirmationstep2_buynow, container, false);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Userdata").child(auth.getCurrentUser().getPhoneNumber()).child("Orders").child("Buynoworder");
        ...
        grandtotal.setText("₹ "+bundle.getString("total_price"));
