...
public class recycler_view_adapter_patiala extends RecyclerView.Adapter<recycler_view_adapter_patiala.ViewHolder> {

    private Context context;
    private List<common_list> uploads;

    public recycler_view_adapter_patiala(Context context, List<common_list> uploads) {
