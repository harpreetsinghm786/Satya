...
public class finish_success_cart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog2 = new Dialog(finish_success_cart.this);
        dialog2.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        dialog2.setContentView(R.layout.terms_condn);
        ...
        cityname = dialog2.findViewById(R.id.devliverycities);
        ...
        cod_card=findViewById(R.id.cod_card_order_finish);
        final LinearLayout drawer = dialog2.findViewById(R.id.tandc_drawer);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    if (cartorder.getOrderid().equals(order_id)) {
                        ...
                        username.setText(cartorder.username);
                        ...
                        if(cartorder.getExtraphonenumber().equals("null")){
                            ...
                            extraphonenumber.setText(cartorder.extraphonenumber);
                        }
        ...
        countinueshopping.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(finish_success_cart.this, MainActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        trackyourorder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(finish_success_cart.this,track_your_order.class);
