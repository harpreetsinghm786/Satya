...
public class recycler_view_adapter_blouse extends RecyclerView.Adapter< recycler_view_adapter_blouse.ViewHolder> {

    private Context context;
    private List<common_list> uploads;

    public recycler_view_adapter_blouse(Context context, List<common_list> uploads) {
