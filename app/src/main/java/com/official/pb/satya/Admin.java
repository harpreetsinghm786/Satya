...
public class Admin extends AppCompatActivity {
    ...
    Button cancelorder, orderdetails, editprogstatus,setprogstatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog_setprog=new Dialog(Admin.this);
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                        if (dataSnapshot1.getKey().equals(orderid)) {
                            cartorder cartorder = dataSnapshot1.getValue(com.official.pb.satya.cartorder.class);
                            progstatus = cartorder.getProg_status();
                            allamount = Integer.valueOf(cartorder.getGrandtotal()) + cartorder.getDeliverycharges();
                ...
                setprogstatus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(seekBar.getProgress()==6){
                            ...
                            Toast.makeText(Admin.this, "Status Updated Successfully", Toast.LENGTH_SHORT).show();
        ...
        orderdetails.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Admin.this, finish_success_cart.class);
        ...
        cancelorder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (progstatus == 0) {
                    ...
                    Toast.makeText(Admin.this, "You cannot cancel any order in progress", Toast.LENGTH_SHORT).show();
                ...
                switch (radioGroup.getCheckedRadioButtonId()) {
                    ...
                    case R.id.r4:
                        if (TextUtils.isEmpty(reson.getText().toString())) {
                            Toast.makeText(Admin.this, "Please enter cause of cancellation", Toast.LENGTH_SHORT).show();
                        } else {
