...
public class Plazo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_plazo, container, false);
        context=getContext();

        progressBar=v.findViewById(R.id.progress);
        recyclerView=v.findViewById(R.id.recycler_view_plazo);
        GridLayoutManager gridLayoutManager=new GridLayoutManager(getContext(),2);
        recyclerView.setLayoutManager(gridLayoutManager);
        post=new ArrayList<>();
        mDatabase = FirebaseDatabase.getInstance().getReference("Genre").child("plazo");
