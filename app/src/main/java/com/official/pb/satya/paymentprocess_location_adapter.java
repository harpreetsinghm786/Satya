...
public class paymentprocess_location_adapter extends RecyclerView.Adapter<paymentprocess_location_adapter.ViewHolder> {
    ...
    public paymentprocess_location_adapter(Context context, List<Address> uploads) {
    ...
    @Override
    public paymentprocess_location_adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.payment_location_item, parent, false);

        paymentprocess_location_adapter.ViewHolder viewHolder = new paymentprocess_location_adapter.ViewHolder(v);
        keys=new ArrayList<>();
    ...
    @Override
    public void onBindViewHolder(final paymentprocess_location_adapter.ViewHolder holder, final int position) {
