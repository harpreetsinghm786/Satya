...
public class recycler_view_adapter_plazo extends RecyclerView.Adapter< recycler_view_adapter_plazo.ViewHolder> {

    private Context context;
    private List<common_list> uploads;

    public  recycler_view_adapter_plazo(Context context, List<common_list> uploads) {
