...
public class recycler_view_adapter_western extends RecyclerView.Adapter< recycler_view_adapter_western.ViewHolder> {

    private Context context;
    private List<common_list> uploads;

    public recycler_view_adapter_western(Context context, List<common_list> uploads) {
